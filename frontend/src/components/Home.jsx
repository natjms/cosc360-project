...
function Home() { 
    ...
    return (
       ...
       <h2 style = {{margin: "40px", textAlign: "center"}}> A GATEWAY TO A NEW WORLD, STORIES, AND LIMITLESS IMAGINATION </h2>
       ...
       <div className = "featuredBooks">
        ...
        <div className = "book1" >
                ...
                <p >Aging and reclusive Hollywood movie icon Evelyn Hugo is finally 
        ...
        <div className = "book2">
                ...
                <p style = {{marginTop: "90px"}}>In the ruins of a place once known as North America lies the nation of Panem, a shining Capitol 
        ...
        <div className = "book3">
            <img src={twilight} alt="twilight" className="twilight" style = {{height: "500px", marginTop: "70px"}}></img>
             <p className = "book3" style = {{padding: "50px"}}>Isabella Swan's move to Forks, a small, perpetually rainy town in Washington, could have been 
